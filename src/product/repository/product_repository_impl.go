...
func (repository *ProductRepositoryImpl) Save(ctx context.Context, tx *sql.Tx, product webProduct.CreateProductRequest) (domain.Product, error) {
	...
	productResponse := domain.Product{
		Id:           id,
...
func (repository *ProductRepositoryImpl) FindById(ctx context.Context, tx *sql.Tx, productId uuid.UUID) (domain.Product, error) {
...
func (repository *ProductRepositoryImpl) Update(ctx context.Context, tx *sql.Tx, product domain.Product) (domain.Product, error) {
	...
	productResponse := domain.Product(product)
